...
<body><h1><u>College students and events management system</u></h1> <center><fieldset>
        <legend><h1>Post reply</h1></legend>

        <form action="postrback.jsp" method="post" style="border:1px solid #ccc">
    

    
  <div class="container">
    <label><b>FROM</b></label><br>
    <input type="text" placeholder="FROM" name="frm" required><br>

    <label><b>TO</b></label><br>
    <input type="text" placeholder="TO" name="ede" required><br>

    <label><b>QUERY</b></label><br>
    <input type="text" placeholder="QUERY" name="eti" required><br>
    
    <label><b>REPLY</b></label><br>
    <input type="text" placeholder="REPLY" name="rply" required><br>
